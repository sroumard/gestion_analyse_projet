...
from . import views
from .views import ProjetListCreateView, KPIListCreateView, TacheListCreateView
urlpatterns = [
    ...
    path('api/kpis/', KPIListCreateView.as_view(), name='api_kpis'),  # URL pour créer une tâche
